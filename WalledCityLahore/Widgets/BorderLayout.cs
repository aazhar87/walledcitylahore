...
{
	public class BorderLayout : ContentView
	{
		public static readonly BindableProperty CornerRadiusProperty =
			BindableProperty.Create<BorderLayout, double>(p => p.CornerRadius, 0);
		...
		public static readonly BindableProperty StrokeProperty =
			BindableProperty.Create<BorderLayout, Color>(p => p.Stroke, Color.Transparent);
		...
		public static readonly BindableProperty StrokeThicknessProperty =
			BindableProperty.Create<BorderLayout, Thickness>(p => p.StrokeThickness, default(Thickness));
		...
		public static readonly BindableProperty IsClippedToBorderProperty =
			BindableProperty.Create<BorderLayout, bool>(p => p.IsClippedToBorder, default(bool));
